...
}]))->withContext('twig.template_cache_warmer', $this), new \Symfony\Bundle\TwigBundle\TemplateIterator(${($_ = isset($this->services['kernel']) ? $this->services['kernel'] : $this->get('kernel', 1)) && false ?: '_'}, 'D:\\projet\\src', ['D:\\projet\\vendor\\symfony\\twig-bridge/Resources/views/Form' => NULL], 'D:\\projet/templates'));
